...
export default function AboutPage() {
  return (
    <>
      ...
      {/**
       * The one place the hairline grid survives as a deliberate exception:
       * five groups of five-plus short mono strings is genuinely reference
       * material, and a tight ruled table beats five floating panels for it.
       * It is framed by a Card-style glass shell (see DenseGrid) so even the
       * exception sits inside the primary language rather than beside it.
       */}
      <Section label="Skills" title="What I work with.">
        <div className="mt-8">
          <DenseGrid>
            {skills.map((group) => (
              <DenseCell key={group.group}>
