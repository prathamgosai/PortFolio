  ...
  return (
    ...
    >
      <PageJsonLd
        type="ContactPage"
        path="/contact"
        name={`Contact ${identity.fullName}`}
        description={`Get in touch with ${identity.fullName} — ${identity.jobTitle}. Based in ${identity.location}, open to ${identity.availability}.`}
      />
      <BreadcrumbJsonLd
        items={[
          { name: "Home", path: "/" },
